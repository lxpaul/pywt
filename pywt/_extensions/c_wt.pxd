...
cdef extern from "c/cwt.h":
    ...
    cdef void double_pois(const double * const input, double * const output, const size_t N,
                                  const size_t number) nogil
    ...
    cdef void float_pois(const float * const input, float * const output, const size_t N,
                                  const size_t number) nogil
